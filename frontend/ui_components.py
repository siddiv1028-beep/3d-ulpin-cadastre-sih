    ...
    with c_controls:
        ...
        with c_btn:
            ...
            if st.button(btn_label, key="theme_toggle_btn", help=btn_help, use_container_width=True):
                ...
                if new_theme == "light" and st.session_state.get("basemap_aesthetic") == "Dark Matter (Default)":
                    st.session_state["basemap_aesthetic"] = "Minimalist Light"
                elif new_theme == "dark" and st.session_state.get("basemap_aesthetic") == "Minimalist Light":
